...
urlpatterns = [
    ...
    path('user_addresses/', UserAddressAPIView.as_view()),
    path('user_addresses/<int:user_address_id>/', SingleUserAddressAPIView.as_view()),
    path('user_infos/', UserInfoAPIView.as_view()),
    path('user_infos/<int:user_info_id>/', SingleUserInfoAPIView.as_view()),
    path('phone_types/', PhoneTypeAPIView.as_view()),
    path('phone_types/<int:phone_type_id>/', SinglePhoneTypeAPIView.as_view()),
    path('user_phones/', UserPhoneAPIView.as_view()),
    path('user_phones/<int:user_phone_id>/', SingleUserPhoneAPIView.as_view()),
    path('page_data/', PageDataAPIView.as_view()),
    path('page_data/<int:page_data_id>/', SinglePageDataAPIView.as_view()),
]
