...
CREATE TABLE UserAddress (
  ...
  FOREIGN KEY (web_user_id) REFERENCES WebUser(web_user_id) ON UPDATE CASCADE ON DELETE RESTRICT,
  FOREIGN KEY (address_type_id) REFERENCES AddressType(address_type_id) ON UPDATE CASCADE ON DELETE RESTRICT
);
